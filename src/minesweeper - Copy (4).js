//minesweeper version 4  20180507 
...
class Board {
	...
	*/
	...
	getNumberOfNeighborBombs(rowIndex, columnIndex) {
		...
		const numberOfRows = this._bombBoard.length; //height of board
		...
		let numberOfBombs = 0; //store number of bombs adjacent to a flipped tile
